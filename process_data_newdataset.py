...
if __name__=='__main__':
    ...
    for index,item_file in enumerate(all_files):
        ...
        print('current processing %d/%d'%(index+1,len(all_files)), "seq len:", seq_len)
    ...
    fname = file_dir.split("/")[-2]
    print(fname, file_dir )
    cPickle.dump(all_files_list,open(f"{fname}.cPickle","wb"))
